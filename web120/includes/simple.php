...
$toName = "Vu Tieu"; //place your client's name here
$website = "Vu's Portal Page";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
$sendEmail = TRUE; //if true, will send an email, otherwise just show user data.
$dateFeedback = true; //if true will show date/time with reCAPTCHA error - style a div with class of dateFeedback
include_once 'portal-config.php'; #site keys go inside your config.php file
